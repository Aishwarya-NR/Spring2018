...
API_KEY = 'AIzaSyA_0It4AVkJVqvakRtalbraIPhtsyY1SOc'
...
TABLE_ID = '1OjdGYyUvGwH7Qh0comd2ygeeE91rIcvSjC6sAYYW'

# This is the default columns for the query
query_cols = []
query_values = ['Europe'] #Change to be the value(s) you're querying in the column you've specified
...
def make_query(cols, values, limit):
    ...
    query = "SELECT " + string_cols + " FROM " + TABLE_ID + " WHERE Region = '" + string_values + "'"
...
def index():
    ...
    res = get_all_data(make_query([], query_values, 50)) #5 is our limit we're passing in
